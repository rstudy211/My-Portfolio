    ...
    <div id="skills" className="container mx-auto py-20 px-6">
      ...
      {skills.length > 6 && (
        <div className="flex justify-center mt-16">
          <button
            className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-lg mr-4 flex items-center transition-all duration-300 ease-in-out"
            onClick={() => setShowAll(!showAll)}
          >
            {showAll ? (
              <>
              ...
              <>
                Show more <i className="fas fa-chevron-down ml-2"></i>
              </>
            )}
          </button>
        </div>
