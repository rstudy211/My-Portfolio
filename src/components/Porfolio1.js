  ...
  return (
    <body class="bg-gray-100 font-sans leading-normal tracking-normal">
        ...
        <div class="container mx-auto flex justify-between items-center py-4">
          <nav class="w-full sm:w-auto flex items-center text-gray-800">
            ...
            <div class="toggle-container">
              <button class="toggle-button" id="toggle-theme">
                Switch to Dark Mode
              </button>
            </div>
          </nav>
          ...
          <div class="flex flex-wrap justify-between items-center">
            <div class="w-full h-full flex flex-col md:w-1/2">
              ...
              <p class="text-gray-700 leading-loose mb-12">
                ...
                passion for creating elegant and user-friendly interfaces that
                enhance the user experience. I'm constantly learning and staying
                up-to-date with the latest technologies to ensure that I'm
                delivering the best possible solutions to my clients.
              </p>
              <a
                href="#contact"
      ...
      <section id="experience" class="bg-white py-20">
        <div class="container mx-auto px-4">
          <h3 class="text-4xl font-bold text-gray-800 mb-8">My Skills</h3>
